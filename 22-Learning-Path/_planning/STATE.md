...
`15-AI-LLMOps/` artık **7/8** (README[P2] + AI-Augmented-Operations[s18] + bu tur LLM-in-Production +
Model-Cost-Optimization + Prompt-Engineering-for-Ops + RAG-Architecture + Safety-and-Guardrails; kalan yalnız Self-Hosted-LLM → slice-20).
Aşama B eşiği (%60) hâlâ uzak (%53.3) — P4 çok turludur, **§14.1.3 dosya-seviyesi dilim** (dilim başına 5 dosya).
