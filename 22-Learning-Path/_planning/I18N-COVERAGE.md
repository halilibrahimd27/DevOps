...
**EN kapsama:** 83 site sayfası / 334 TR temel sayfası ≈ **%24.9** (Aşama B eşiği %60).
...
+ P3 slice-2: 5 deep-dive + P3 slice-3: 5 deep-dive = 83. Kök `README.en.md` GitHub-only, siteye stage edilmez → oran dışı.)
