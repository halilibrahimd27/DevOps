...
**EN kapsama:** 168 site sayfası / 334 TR temel sayfası ≈ **%50.3** (Aşama B eşiği %60).
...
| 86+ | sonra kalan 00-21 deep-dive'ları klasör sırasıyla (`14-Sustainability/*` kalan 4: Efficiency-Practices/Green-Software-Principles/Measuring-Software-Carbon/Region-Selection → `15-AI-LLMOps/*` kalan 7; 12-FinOps/13-Platform-Engineering tam) → `16-Cheatsheets/` (kalan 8) → `17-Templates/` index'leri → en son `21-Field-Notes/` | 18+ |
