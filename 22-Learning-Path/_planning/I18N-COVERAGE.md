...
**EN kapsama:** 24 site sayfası / 334 TR temel sayfası ≈ **%7.2** (Aşama B eşiği %60).
(P0: 3 sayfa + P1a rehber twin'leri: 9 sayfa + P1b Blok A+B: 12 sayfa = 24. Kök
...
| **P1b** | Patika omurgası — **30 modül** + **5 STAGE-EXAM** twin'i `block-*/<ID>-*.en.md` (A0…F5) | 🟡 **Kısmen — Blok A+B hazır** (2026-07-23). Bu tur 12 twin: A0–A6 + Blok A STAGE-EXAM (8) · B1–B3 + Blok B STAGE-EXAM (4). 12 paralel çeviri subagent, dosya başına bir, sıkı ruleset. Başlık paritesi 12/12, link locale-eksiz (0 sızıntı), positioning temiz, kod-yorumu çevrildi/komut verbatim; `/en/…/A1-linux-temeli/` İngilizce render, qa exit 0. **Kalan:** C0–C4 (5) + D1–D5 (5) + E1–E5 (5) + F1–F5 (5) = 20 modül + C/D/E STAGE-EXAM (3) = 23 dosya. `qa.py` locale-farkındalığı (`LOCALE_RE`) modül twin'lerini bütünlük denetiminden muaf tutuyor; iç link kuralı (locale-eksiz hedef) değişmez. |
