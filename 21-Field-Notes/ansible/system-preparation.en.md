---
description: "System preparation with Ansible before Kubernetes: creating the production inventory file, master/worker host definitions, etcd member and node label settings."
tags:
  - Field Notes
  - Kubernetes
  - IaC
  ...
  - Networking
---
# System Preparation with Ansible
...
# Create the system preparation playbook
mkdir -p playbooks
...
# Run the container runtime installation
...
# Run the Kubernetes packages installation
