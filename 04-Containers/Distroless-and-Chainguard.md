...
> ~5 CVE. Chainguard = **near-zero CVE, daily rebuild**. 'Hangi
> base?' sorusunun cevabı 2026'da çoktan değişti."*

Bu rehber distroless ve Chainguard image'larını, niye **2026 standardı**
olduklarını, migration stratejisini, ve trade-off'ları anlatır.
...
> **Distroless**: Google'ın projesi, sadece **uygulama runtime
> dependencies** içerir. Shell, package manager, debugger **yok**.
...
> **Chainguard**: 2022'de kurulan startup. **Wolfi** (mini distro) üzerine
> kurulu. Daily rebuild + **near-zero CVE** taahhüdü.
...
Bkz [`Image-Signing-Cosign.md`](Image-Signing-Cosign.md) ve [`08-Security/Policy-as-Code-OPA-Kyverno.md`](../08-Security/Policy-as-Code-OPA-Kyverno.md).
...
> *"Distroless 'extreme' değil — **2026 production standardı**.
> Ubuntu base ile prod'a image push'layan ekip, **CVE backlog
> dağı** ile uğraşırken; Chainguard ile push'layan ekip **near-zero
> CVE** rapor verir."*
